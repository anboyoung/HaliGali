...
public class GameWindow2 extends JPanel{
	...
	public GameWindow2(){
		back=Toolkit.getDefaultToolkit().getImage("C:\\image\\monkey_back3.jpg");	//뒷배경
		
		String[] col1={"방이름2","인원2","게임상태2"};	//방테이블
		String[][] row1=new String[5][3];	//col1열의 수에 맞게 5줄로 생성
		model1=new DefaultTableModel(row1, col1);
		table1=new JTable(model1);
		JScrollPane js1=new JScrollPane(table1);
		
		String[] col2={"순위2","ID2","승률2"};		//순위표테이블
		String[][] row2=new String[0][3];
		model2=new DefaultTableModel(row2, col2);
		table2=new JTable(model2);
		JScrollPane js2=new JScrollPane(table2);
		
		String[] col3={"ID2","승률2"};				//접속자테이블
		...
		b1=new JButton("전송2");					//채팅전송버튼
		
		b2=new JButton("도움말2");					//도움말버튼
		b3=new JButton("방만들기2");				//방만들기버튼
		...
		js2.setBounds(10, 340, 247, 220);	//순위표
		js3.setBounds(262, 340, 247, 220);	//접속자
		js4.setBounds(515, 15, 265, 200);	//채팅
		tf.setBounds(515, 220, 200, 30);	//채팅입력창
		b1.setBounds(720, 220, 60, 30);
		profile.setBounds(515, 255, 265, 180);	//사용자 정보
		p.setBounds(515, 440, 265, 120);		//버튼묶음
